                          ...
                          {showRevisionForm !== index ? (
                            <div className="flex gap-2">
                              <button
                                ...
                                disabled={isGenerating}
                                className="flex-1 bg-amber-50 hover:bg-amber-100 text-amber-700 font-semibold py-2.5 px-4 rounded-lg transition-all flex items-center justify-center gap-2 border border-amber-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                              ...
                              {onClearChapter && (
                                <button
                                  onClick={() => {
                                    if (window.confirm('Are you sure you want to clear this chapter? This will reset it to pending status and you can regenerate it from scratch. This action can be undone using the revision history.')) {
                                      onClearChapter(index);
                                    }
                                  }}
                                  disabled={isGenerating}
                                  className="flex-1 bg-red-50 hover:bg-red-100 text-red-700 font-semibold py-2.5 px-4 rounded-lg transition-all flex items-center justify-center gap-2 border border-red-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                                >
                                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
